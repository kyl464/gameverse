  ...
  return (
    <div className="flex flex-col md:flex-row w-full max-w-screen-xl mx-auto p-4 ">
      <div className="w-full md:w-2/3 space-y-6">
        ...
        <div className="bg-gray-800 rounded-lg">
          <div className="grid grid-cols-[auto_1fr]">
            <h2 className="text-lg bg-purple-500 font-semibold px-4 text-white pt-2 pb-2 rounded-tl-lg"></h2>
            <h2 className="text-lg bg-gray-500 font-semibold pl-4 text-white pt-2 pb-2 rounded-tr-lg">
              Deskripsi
            </h2>
          </div>
          <div className="mt-3 pl-4 pb-4 pr-4">
            <p className="text-gray-300 mt-2">
              Ini adalah deskripsi tentang game dan top-up.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg">
          ...
          <div className="mt-3 pl-4 pb-4 pr-4">
            {selectedVarian ? (
              ...
              <p className="text-gray-400">Pilih produk untuk melihat total</p>
            )}
          </div>
        </div>
